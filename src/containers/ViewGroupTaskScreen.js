...
import DateCreatedLabel from "../components/viewTask/DateCreatedLabel";
import DueDateLabel from "../components/viewTask/DueDateLabel";
import TaskTitleLabel from "../components/viewTask/TaskTitleLabel";
import DescLabel from "../components/viewTask/DescLabel";
import AddSubTaskButton from "../components/viewTask/AddSubTaskButton";
import Lvl1Task from "../components/lvl2Task/Lvl1Task";
...
import {
    server_ip,
    addGroupSubtaskUrl, 
    updateGroupSubtaskUrl, 
    deleteTaskUrl, 
    putTaskArchiveUrl, 
    deleteSubtaskUrl, 
    updateSubtaskProgressUrl, 
    leaveTaskUrl, 
    checkSubtaskUrl, 
    viewTaskUrl, 
    getSubtaskUrl, 
...
class ViewGroupTaskScreen extends React.Component {
    ...
    componentDidMount() {
        const url = server_ip + viewTaskUrl;
        ...
        const url_2 = server_ip + getSubtaskUrl;
    ...
    componentWillUnmount() {
        ...
        if (values != '') {
            const url = server_ip + updateTaskUrl;
            let content = JSON.stringify({
                user_id: this.state.user_id,
                task_id: this.props.navigation.getParam("task_id", "0"),
                values: values,
    ...
    putSubTask = () => {
        const url = server_ip + addGroupSubtaskUrl;
    ...
    updateSubTask = () => {
        const url = server_ip + updateGroupSubtaskUrl;
        let content = JSON.stringify({
            user_id: this.state.user_id,
            task_id: this.props.navigation.getParam("task_id", "0"),
    ...
    deleteTask = () => {
        const url = server_ip + deleteTaskUrl;
        let content = JSON.stringify({
            task_id: this.props.navigation.getParam("task_id", "0")
        });
    ...
    putArchive = () => {
        const url = server_ip + putTaskArchiveUrl;
        let content = JSON.stringify({
            task_id: this.props.navigation.getParam("task_id", "0"),
        });
    ...
    subTaskProgress = (id, progress) => {
        const url = server_ip + updateSubtaskProgressUrl;
        let content = JSON.stringify({
            task_id: this.props.navigation.getParam("task_id", "0"),
            subtask_id: id,
            progress: progress
    ...
    leaveTask = (id) => {
        const url = server_ip + leaveTaskUrl;
        let content = JSON.stringify({
            task_id: this.props.navigation.getParam("task_id", "0"),
            subtask_id: id,
            user_id: this.state.user_id
    ...
    checkLvl1Task = (subtask_id) => {
        const url = server_ip + checkSubtaskUrl;
        let content = JSON.stringify({
