...
import SubTask from "../components/viewTask/SubTask";
import formsStyle from "../components/styles/formsStyle";
import styles from "../components/styles/style";
import { fetchData } from "../helpers/FetchData";
import LoadingScreen from "../components/LoadingScreen";
import { server_ip, getSubtaskUrl, updateTaskUrl, addSubtaskUrl, deleteTaskUrl, deleteSubtaskUrl, checkSubtaskUrl } from "../constants";
...
class ViewTaskScreen extends React.Component {
  ...
  putSubTask = () => {
    const url = server_ip + addSubtaskUrl;
  ...
  updateSubTask = () => {
    const url = server_ip + updateSubtaskUrl;
    let content = JSON.stringify({
